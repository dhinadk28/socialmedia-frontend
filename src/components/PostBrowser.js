    ...
    <>
      <Stack spacing={2}>
        ...
        {searchExists && (
          <Box>
            <Typography 
            color='secondary'variant="h5" gutterBottom>
        ...
        {end ? (
          <Stack py={5} alignItems="center">
            ...
            <Button 
            color='secondary'variant="text" size="small" onClick={handleBackToTop}>
              Back to top
            </Button>
          </Stack>
        ) : (
          ...
          posts.length > 0 && (
            <Stack pt={2} pb={6} alignItems="center" spacing={2}>
              <Button color='secondary' onClick={fetchPosts} variant="contained">
                Load more
              </Button>
              <Button color='secondary'variant="text" size="small" onClick={handleBackToTop}>
                Back to top
              </Button>
            </Stack>
          )
